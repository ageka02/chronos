        ...
        <div class="breadcrumbs bg-dark" style="border-bottom: currentColor; ">
            ...
            <div class="col-sm-4">
                <div class="page-header bg-dark text-sm-center">
                    <div class="page-title">
                        <h1 class="text-white">J2 - PRODUCTIVITY PER HOURS</h1>
                    </div>                    
                </div>
            </div>
            <div class="col-sm-4">
                ...
                <div class="card" style="height: auto; " >
                   <table width="100%">
                       <tr>
                        ...
                        $total_mp_actual = 0;
                        $total_mp_actual = $data_line['mp_actual'];
                         ?>
                        <tr>
                            <th>
                        ...
                        //GET PPH ACTUAL
                            ...
                            if ($day != 'Friday') {
                                if ($date_scan != $today) {
                                    if (strtotime($get_last) <= strtotime('16:30')) {
                                ...
                                if ($date_scan != $today) {
                                    if (strtotime($get_last) <= strtotime('17:00')) {
                                        $diff = strtotime('17:00') - strtotime('08:30');
                                    }else{
                                        $diff = strtotime('17:00') - strtotime('08:30');
                                    }
                                    $selisih = floor($diff/(60*60));
                                    // echo $get_last.' '.$selisih;
                                }else{
                                    if (strtotime(date('H:i')) < strtotime('11:30')) {
                                        $diff = strtotime(date('H:i')) - strtotime('06:30');
                            ...
                            $total_mp_day = ($total_mp_actual*$selisih)+($data_line['mp_ot']*$data_line['h_ot']);

                            $pph_actual = 0;
                            $pph_actual = round($actual/$total_mp_day,2);
                         ?>
                         <tr>
                             <th colspan="2">
                                 <h4>PPH DAILY</h4>
                         ...
                         <?php 
                            ...
                            if ($pph_actual <= $data_line['pph_standard']) {
                                $bg = "bg-danger";
                            }else{
                                $bg = "bg-success";
                            }
                        ...
                        ?> 
                         <tr>
                             <th colspan="" class="<?php echo $bg; ?>">
                                <h1 class="text-sm-center text-white" style="font-size: 60px;"><?php echo round($pph_percentage,2).'%'; ?></h1>
                             </th>
                         </tr>
                   </table>
                </div>
...
<script src="vendors/jquery/dist/jquery.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        setTimeout(function(){window.location='pph_chart.php';},60000);
