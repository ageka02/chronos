                                ...
                                <div class="animated fadeIn">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="card" >
                                                <div class="card-header">
                                                    <h4><?php echo $building." ACTUAL OUTPUT"; ?> 
                                                    </h4>
                                                </div>
                                                <div class="card-body">
                                                    <canvas id="<?php echo "oph".$i; ?>"></canvas> 
                                                </div>
                                            </div>
                                        </div><!-- /# column -->
                                    </div> <!-- end row -->
                                ...
                                <div class="animated fadeIn">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="card" >
                                                <div class="card-header">
                                                    <h4><?php echo $building." PPH"; ?> 
                                                    </h4>
                                                </div>
                                                <div class="card-body">
                                                    <canvas id="<?php echo "pph".$i; ?>"></canvas> 
                                                </div>
                                            </div>
                                        </div><!-- /# column -->
                                    </div> <!-- end row -->
...
<?php     
    ...
    while ($k < count($data_id)) {
        ...
        while ($oph_i < count($label_temp)) {
            if ($label_temp[$oph_i] == '11:00' && $label_temp[$oph_i+1] == '12:00') {
                $label[] = $label_temp[$oph_i];
                $oph[] = $oph_temp[$oph_i] + $oph_temp[$oph_i+1];
            }elseif($label_temp[$oph_i] != '12:00'){
                $label[] = $label_temp[$oph_i];
                $oph[] = $oph_temp[$oph_i];
            }
            $oph_i++;
        ...
        $mp_actual = $vd->mp_actual($date_scan,$data_line[$k],$data_dept[$k]);
        foreach ($mp_actual as $value) {
            while ($l < count($oph)) {
                $pph_actual = round($oph[$l]/$value['actual'],2);
            ...
            data: {
                ...
                datasets: [{
                    ...
                    formatter: function(value) {
                        ...
                        data: [ 
                            <?php 
                                foreach ($pph_actual_percentage as $value) {
                                    echo $value.",";
                                }                    
                             ?>
                         ],
...
<script>
    ...
    while(i <= 6){
        ...
        //CHART OPH
        var ctx = document.getElementById("oph"+i);
        ctx.height = 60;
        var myChart = new Chart( ctx, {
            plugins: [ChartDataLabels],
            type: 'line',
            data: {
                labels: ['08:00','09:00','10:00','11:00','13:00','14:00','15:00','16:00'],
                type: 'bar',
                defaultFontFamily: 'Montserrat',
                datasets: [{
                    type: 'line',
                    ...
                    display: false
                        ...
                        label: "Target 264",
                        data: [264,264,264,264,264,264,264,264,],
                        borderColor: "rgba(0, 123, 255, 0.9)",
                        borderWidth: "2",
                        backgroundColor: "rgba(0, 123, 255, 0)",
                    }
        ...
        // CHART PPH
        var ctx = document.getElementById("pph"+i);
        ctx.height = 60;
        var myChart = new Chart( ctx, {
            plugins: [ChartDataLabels],
            type: 'line',
